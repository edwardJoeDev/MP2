...
import redash from "../img/graytwodasher.png";
    ...
    <div className="container">
        <div className="firstrow">
                <div className="col-md-4">
                    <img src={redash} alt="grinad" style={{ width: '100px', height: '100px' }}/></div>
        
                <div className="col-md-4">
                     <h1 >NEWS FEEDS AND ANNOUNCEMENTS</h1>
                </div>
                <div className="col-md-4" >
                    <img src={redash} alt="grinad" style={{ width: '100px', height: '100px' }}/>
                </div>
         </div>   
